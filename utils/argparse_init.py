...
def init_parse_argparse_default_params(parser, dataset_name=None, arch=None):
    ...
    parser.add_argument("--num_data_workers", default=20, type=int, help="for parallel data load")
    ...
    parser.add_argument("--model_type_for_encoder", default='DGCNN', help="model type for encoder (DGCNN or PCT")
    parser.add_argument('--dropout_PCT', type=float, default=0.5,
                        help='dropout rate')
